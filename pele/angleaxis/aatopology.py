...
try:
    ...
    from pele.angleaxis._aa_utils import _rot_mat_derivative as rotMatDeriv
    from pele.angleaxis._aa_utils import _sitedist_grad as sitedist_grad
    from pele.angleaxis._aa_utils import _sitedist as sitedist
